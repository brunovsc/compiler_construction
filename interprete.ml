      ...
      (match tesq with
       | TipoInt ->
         (match op with
          ...
          | Menor_Igual    -> ExpBool (pega_int vesq <= pega_int vdir, top)
          | Maior_Igual    -> ExpBool (pega_int vesq >= pega_int vdir, top)
       ...
       | TipoFloat ->
         (match op with
          ...
          | Menor_Igual    -> ExpBool (pega_float vesq <= pega_float vdir, top)
          | Maior_Igual    -> ExpBool (pega_float vesq >= pega_float vdir, top)
          | _ -> failwith "interpreta_relacional"
         )
       | TipoString ->
         (match op with
          ...
          | Menor_Igual    -> ExpBool (pega_string vesq <= pega_string vdir, top)
          | Maior_Igual    -> ExpBool (pega_string vesq >= pega_string vdir, top)
          | _ -> failwith "interpreta_relacional"
         )
       | TipoBool ->
         (match op with
          ...
          | Menor_Igual    -> ExpBool (pega_bool vesq <= pega_bool vdir, top)
          | Maior_Igual    -> ExpBool (pega_bool vesq >= pega_bool vdir, top)
          | _ -> failwith "interpreta_relacional"
         )
       | _ ->  failwith "interpreta_relacional"
      )
...
let interprete ast =
  ...
  let (A.Programa (decs_funs, corpo)) = ast in
