...
funcao: TInt Main AParen argumentos FParen AChave comandos FChave
	{ Funcao(TInt, ExpVar "main", [], $7, ExpInt 1)}
	| tipo Ident AParen argumentos FParen AChave comandos
	Return expressao PTVirg FChave { Funcao($1, ExpVar $2, $4, $7, $9)}
